...
Reviewed/approved: 0/7; unexplained High conflicts: 7.

| conflict_key | user_id | permission_a | permission_b | conflict_description | risk | business_justification | management_decision | permission_change | compensating_control | expiry_date | status | approved_by | approval_date |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

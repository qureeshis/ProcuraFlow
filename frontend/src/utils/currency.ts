...
export function formatCurrency(value: number | string | null | undefined, currency = getStoredCurrency()) {
...
export function currencyFieldLabel(label: string, currency = getStoredCurrency()) {
...
export function isCurrencyField(key: string) {
